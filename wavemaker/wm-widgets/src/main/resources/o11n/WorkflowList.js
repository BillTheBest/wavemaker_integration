dojo.provide("common.packages.o11n.WorkflowList");
 
dojo.declare("o11n.WorkflowList", wm.Composite, {
  ...
  layoutKind: "top-to-bottom",
    ...
    load: function() {
        ...
        this.components.workflowService.update();
    ...
    workflowServiceSuccess: function(inSender, inDeprecated) {
        ...
        this.components.workflows_grid.show();
    },
    ...
    disableDefaultSortingIfPagination: function() {
        if (this.components.maxPaginationVar.data.dataValue > 1) {
            this.components.workflows_grid.dojoObj.canSort = function() {
                return false;
            };
        }
    },
    ...
    runButtonClick: function(inSender) {
        var workflowId = this.components.workflows_grid.selectedItem.getData().id;
...
wm.registerPackage(["vCO Widgets", "WorkflowList", "o11n.WorkflowList", "common.packages.o11n.WorkflowList", "images/wm/widget.png", "List of all workflows.", {width: "100%", height: "100%"},false]);