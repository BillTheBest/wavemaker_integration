...
wm.types = {
	"types": {
		...
		"com.vmware.o11n.sdk.rest.client.stubs.Parameter": {
			"fields": {
				"array": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.sdk.rest.client.stubs.Array"
				},
				"composite": {
					"exclude": [],
					"fieldOrder": 1,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.sdk.rest.client.stubs.Composite"
				},
				"date": {
					"exclude": [],
					"fieldOrder": 2,
				...
				"mimeAttachment": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.sdk.rest.client.stubs.MimeAttachment"
				},
				"name": {
					"exclude": [],
					"fieldOrder": 5,
				...
				"properties": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.sdk.rest.client.stubs.Properties"
				},
				"scope": {
					"exclude": [],
					"fieldOrder": 8,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.sdk.rest.client.stubs.Scope"
				},
				"sdkObject": {
					"exclude": [],
					"fieldOrder": 9,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.sdk.rest.client.stubs.SdkObject"
				},
				"secureString": {
					"exclude": [],
					"fieldOrder": 10,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.sdk.rest.client.stubs.SecureString"
				},
				"string": {
					"exclude": [],
					"fieldOrder": 11,
		...
		"com.vmware.o11n.sdk.rest.client.stubs.User": {
			"fields": {
				"adminRights": {
					"exclude": [],
					"fieldOrder": 1,
		...
		"com.vmware.o11n.wm.common.BaseParameter": {
			"fields": {
				"description": {
					"exclude": [],
					"fieldOrder": 0,
		...
		"com.vmware.o11n.wm.common.ExecutionParameter": {
			"fields": {
				"displayValue": {
					"exclude": [],
					"fieldOrder": 0,
		...
		"com.vmware.o11n.wm.common.FilterType": {
			"fields": {
				"displayValue": {
					"exclude": [],
					"fieldOrder": 0,
		...
		"com.vmware.o11n.wm.common.PaginatedUserInteractions": {
			"fields": {
				"list": {
					"exclude": [],
					"fieldOrder": 0,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.UserInteractionModel"
				},
				"start": {
					"exclude": [],
					"fieldOrder": 1,
		...
		"com.vmware.o11n.wm.common.PaginatedWorkflowExecutions": {
			"fields": {
				"list": {
					"exclude": [],
					"fieldOrder": 0,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.WorkflowExecutionModel"
				},
				"start": {
					"exclude": [],
					"fieldOrder": 1,
		...
		"com.vmware.o11n.wm.common.PaginatedWorkflows": {
			"fields": {
				"list": {
					"exclude": [],
					"fieldOrder": 0,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.WorkflowModel"
				},
				"start": {
					"exclude": [],
					"fieldOrder": 1,
		...
		"com.vmware.o11n.wm.common.PresentationParameter": {
			"fields": {
				"name": {
					"exclude": [],
					"fieldOrder": 0,
		...
		"com.vmware.o11n.wm.common.QuerySpec": {
			"fields": {
				"conditions": {
					"exclude": [],
					"fieldOrder": 0,
		...
		"com.vmware.o11n.wm.presentation.dao.CatalogModel": {
			"fields": {
				"catalogPages": {
					"exclude": [],
					"fieldOrder": 1,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.CatalogPage"
				},
				"categories": {
					"exclude": [],
					"fieldOrder": 0,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.CategoryModel"
				}
			},
			"internal": false,
			"liveService": false,
		...
		"com.vmware.o11n.wm.presentation.dao.CatalogPage": {
			"fields": {
				"catalogItems": {
					"exclude": [],
					"fieldOrder": 1,
		...
		"com.vmware.o11n.wm.presentation.dao.CategoryModel": {
			"fields": {
				"id": {
					"exclude": [],
					"fieldOrder": 1,
		...
		"com.vmware.o11n.wm.presentation.dao.ExecutionStateModel": {
			"fields": {
				"executionId": {
					"exclude": [],
					"fieldOrder": 0,
		...
		"com.vmware.o11n.wm.presentation.dao.FieldModel": {
			"fields": {
				"constraints": {
					"exclude": [],
					"fieldOrder": 0,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.ConstraintsModel"
				},
				"decorators": {
					"exclude": [],
					"fieldOrder": 1,
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.DecoratorsModel"
				},
				"displayName": {
					"exclude": [],
					"fieldOrder": 2,
				...
				"fieldType": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.FieldModel.FieldTypeModel"
				},
				"hidden": {
					"exclude": [],
					"fieldOrder": 4,
				...
				"messages": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.MessageModel"
				},
				"type": {
					"exclude": [],
					"fieldOrder": 7,
		...
		"com.vmware.o11n.wm.presentation.dao.GroupModel": {
			"fields": {
				"description": {
					"exclude": [],
					"fieldOrder": 0,
				...
				"fields": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.FieldModel"
				},
				"hidden": {
					"exclude": [],
					"fieldOrder": 3,
		...
		"com.vmware.o11n.wm.presentation.dao.InventoryObjectModel": {
			"fields": {
				"data": {
					"exclude": [],
					"fieldOrder": 2,
		...
		"com.vmware.o11n.wm.presentation.dao.PresentationModel": {
			"fields": {
				...
				"steps": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.StepModel"
				},
				"valid": {
					"exclude": [],
					"fieldOrder": 5,
		...
		"com.vmware.o11n.wm.presentation.dao.StepModel": {
			"fields": {
				"description": {
					"exclude": [],
					"fieldOrder": 0,
				...
				"groups": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.presentation.dao.GroupModel"
				},
				"hidden": {
					"exclude": [],
					"fieldOrder": 3,
		...
		"com.vmware.o11n.wm.presentation.dao.UserInteractionModel": {
			"fields": {
				"createDate": {
					"exclude": [],
					"fieldOrder": 0,
		...
		"com.vmware.o11n.wm.presentation.dao.WorkflowExecutionModel": {
			"fields": {
				"businessState": {
					"exclude": [],
					"fieldOrder": 0,
				...
				"inputParameters": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.common.ExecutionParameter"
				},
				"name": {
					"exclude": [],
					"fieldOrder": 5,
		...
		"com.vmware.o11n.wm.presentation.dao.WorkflowModel": {
			"fields": {
				"canEdit": {
					"exclude": [],
					"fieldOrder": 0,
				...
				"inputParameters": {
					...
					"noChange": [],
					"required": true,
					"type": "com.vmware.o11n.wm.common.BaseParameter"
				},
				"name": {
					"exclude": [],
					"fieldOrder": 8,
		...
		"com.vmware.o11n.wm.presentation.dao.WorkflowRunEvent": {
			"fields": {
				"date": {
					"exclude": [],
					"fieldOrder": 0,
...
dojo.declare("vco", wm.Application, {
...
vco.prototype._css = 'body.wm_default{\
background-color: #4B93C5;\
background-image: url("resources/images/backgrounds/body_bg.png");\
...
.wm_default #wavemakerNode > div > .wmlayout{\
background-color: #4B93C5;\
background-image: url("resources/images/backgrounds/body_bg.png");\
background-position: center top;\
background-repeat: no-repeat;\
...
background-color: #999999 !important !important;\
}\
.dojoxGridHeader{\
...
wmtablayers-tab > button{\
background-color: #eeeeee !important;\
}\
.wmtablayers-selected{\
background-color: #FFFFFF !important;\
...
/****************************** Workflow Catalog Widget Styles: BEGINS *****************/\
.clearfix:after {\
clear: both;\
content: ".";\
display: block;\
...
.workflow-catalog label > span, span.clearfix {\
color: #666666;\
display: block;\
font-size: 12px;\
line-height: 1.6em;\
...
background: #FCFCFC;\
/* all backrounds below are totally optional. a bit a difference but not so much */\
...
.workflow-catalog li.focused,\
.workflow-catalog li:hover {\
background: #79BEF0;\
/* all backrounds below are totally optional. a bit a difference but not so much */\
background: -moz-linear-gradient(center top , #BADEF7 0px, #BADEF7 30%, #6CB7E3 90%) repeat scroll 0 0 transparent;\
...
.workflow-catalog li.selection {\
background: #2A95DF;\
/* all backrounds below are optional. nice to have only */\
...
background: -moz-linear-gradient(center top , #79BEF0 0px, #79BEF0 30%, #017FD6 90%) repeat scroll 0 0 transparent;\
}\
.workflow-catalog li.selection label {\
border-color: #79BEF0 #79BEF0 #017FD6;\
box-shadow: 0 6px 10px rgba(20, 20, 20, 0.2) inset;\
}\
.workflow-catalog li.focused label > span,\
.workflow-catalog li:hover label > span,\
.workflow-catalog li.selection label > span {\
background: none repeat scroll 0 center transparent;\
}\
.workflow-catalog .wf-specs .header {\
display: block;\
...
.workflow-catalog .wf-specs .header .title {\
display: inline;\
float: right;\
text-align: left;\
color: #000000;\
...
.workflow-catalog .wf-specs .wf-icon {\
display: block;\
height: 96px;\
width: 96px;\
margin-bottom: 4px;\
...
.workflow-catalog .wf-specs .wf-icon img {\
width: 100%;\
height: 100%;\
}\
.workflow-catalog .wf-specs .wf-desc {\
display: block;\
margin-right: 14px;\
height: 96px;\
margin-bottom: 4px;\
...
.catalog-category label > span, span.clearfix {\
color: #666666;\
display: block;\
font-size: 14px;\
font-family: Verdana;\
...
.catalog-category li.focused,\
.catalog-category li:hover {\
background: #999999; /*#79BEF0;*/\
}\
.catalog-category li.selection {\
background: #999999; /*#2A95DF;*/\
}\
.catalog-category li.selection label {\
border-color: #79BEF0 #79BEF0 #017FD6;\
box-shadow: 0 6px 10px rgba(20, 20, 20, 0.2) inset;\
}\
.catalog-category li.focused label > span,\
.catalog-category li:hover label > span,\
.catalog-category li.selection label > span {\
background: none repeat scroll 0 center transparent;\
}\
html.WMApp body .back-button {\
cursor: pointer;\
}\
/****************************** Workflow Catalog Widget Styles: ENDS *****************/\
html.WMApp body .answer {\
background-color: #ffffff !important;\
